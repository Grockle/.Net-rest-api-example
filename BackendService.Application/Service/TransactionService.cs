...
namespace BackendService.Application.Service
{
    public class TransactionService : ITransactionService
    {
        ...
        public async Task<BaseResponse<bool>> AddExpenseAsync(AddExpenseRequest request)
        {
        ...
        public async Task<BaseResponse<bool>> AddTransferAsync(AddTransferRequest request)
        {
            var response = new BaseResponse<bool> { HasError = false, Data = false };
            var group = await _groupRepository.GetByIdAsync(request.GroupId);
